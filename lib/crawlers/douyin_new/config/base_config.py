...
# 缓存类型（简化版只支持本地缓存）
CACHE_TYPE_REDIS = "memory"   # 固定使用本地内存缓存
CACHE_TYPE_MEMORY = "memory"  # 本地内存缓存类型标识
...
# 数据保存类型选项配置,支持: csv、json、excel
SAVE_DATA_OPTION = "json"  # csv or json or excel
